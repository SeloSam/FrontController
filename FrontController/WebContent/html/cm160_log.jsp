...
<script type="text/javascript">
	...
	/* $(document).ready(function(){
		...
		$("#add1").blur(function(){
			if($("#add1").val()==""){
				$("#id_span").empty().append("3~16자 영문 및 숫자 입력").css("color", "red");
			} 
		});
	...
	$(document).on("click", "#butten1", function(){
		...
		if(id==""){0
			...
			userid.focus();
			$("#id_span").empty().append("정확히 입력하세요").css("color", "red");
			return false;
		}else{
			$("#id_span").empty().append("사용가능한 id입니다.").css("color", "green");
		}
...
<body> 
	...
	<form action="cm160_welcome.jsp" class="w3-container" id= "form_id" name="160cm_join" method="post" onSubmit="return checked()" onReset="clearform()">
			<fieldset>
					...
					<input type="text" id="add1" name="id" size ="15" maxlength="15" placeholder="ID" class="w3-input">
					<span id="id_span"></span>
					<p>
					
					<p>
					<label for="add2"> PW </label><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" alt="필수">
					<input type="password" id="add2" name="pw1" size ="15" maxlength="15" placeholder="Pw1" class="w3-input">
					...
					<input type="password" id="add3" name="pw2" size ="15" maxlength="15" placeholder="Pw2" class="w3-input">
					...
					<input type="text" id="add4" name="name" size ="15" maxlength="4" placeholder="Name" class="w3-input">
					<span id="name_span"></span>
					</p>
					
					<p>
					<label for="add5"> 전화번호 </label><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" alt="필수">
					<input type="text" id="add5" name="phone" size ="15" maxlength="13" placeholder="Phone" class="w3-input">
					<span id="phone_span"></span>
					</p>
					
					<p>
					<label for="add6"> 이메일 </label><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" alt="필수">
					<input type="text" id="add6" name="email" size ="15" maxlength="18" placeholder="Email" class="w3-input">
