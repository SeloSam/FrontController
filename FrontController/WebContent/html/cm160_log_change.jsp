    ...
    function sample6_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById('add8').value = data.zonecode; //5자리 새우편번호 사용
                document.getElementById('add7').value = fullAddr;
...
<body>
	...
	<form action="IndexAction" class="w3-container" id="form_logchange"  name="160cm_join" method="post" onSubmit="return checked()" onReset="clearform()">
			...
			<fieldset>
				<div class="w3-contrainer w3-red" id="field_id">
					<h2> -회원 수정- </h2>
							...
							<input type="text" class="w3-input" readonly="readonly" id="add1" value="${sessionScope.loginUser.userid}" name="id" size ="15" maxlength="15" placeholder="ID">
							<span id="id_span"></span>
							</p>
							
							<p>
							<label for="add2"> PW </label><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" alt="필수">
							<input type="password" class="w3-input" id="add2" name="pw1" value="${sessionScope.loginUser.userpw}" size ="15" maxlength="15" placeholder="Pw1">
							...
							<input type="password" class="w3-input" id="add3" name="pw2" value="${sessionScope.loginUser.userpw}" size ="15" maxlength="15" placeholder="Pw2">
							...
							<input type="text" id="add4" class="w3-input" name="name" value="${sessionScope.loginUser.username}" size ="15" maxlength="4" placeholder="Name">
							<span id="name_span"></span>
							</p>
							
							<p>
							<label for="add5"> 전화번호 </label><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" alt="필수">
							<input type="text" id="add5" class="w3-input" name="phone" value="${sessionScope.loginUser.userphone}" size ="15" maxlength="13" placeholder="Phone">
							<span id="phone_span"></span>
							</p>
							
							<p>
							<label for="add6"> 이메일 </label><img src="http://img.echosting.cafe24.com/skin/base_ko_KR/member/ico_required.gif" alt="필수">
							<input type="text" id="add6" class="w3-input" name="email" size ="15" value="${sessionScope.loginUser.useremail}" maxlength="18" placeholder="Email">
							...
							<input type="text" id="add8" name="address2" size ="8" maxlength="10" placeholder="우편번호" class="w3-input">
							<input type="text" id="add7" name="address" size ="35" maxlength="18" placeholder="기본주소" class="w3-input">
